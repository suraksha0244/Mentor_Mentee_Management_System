...
<body>
   ...
   <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="mentor.php"><img src="img/download.png" alt="" title="" /></img></a>
  ...
  <section 
  style="background-image: url(./img/sahyadri.jpg)" class="hero">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-12">
          <a class="hero-brand" href="index.php" title="Home"><img alt="Bell Logo" src="img/download.png" width="70" height="70"></a>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <a class="btn btn-full" href="studentdet.php"> Mentee Details</a>
