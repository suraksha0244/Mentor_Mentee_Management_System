  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="https://sahyadri.edu.in/"><img src="img/download.png" alt="" title="" /></img></a>
...
background-image: url(./img/sahyadri.jpg)"class="hero">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-12">
          <a class="hero-brand" href="https://sahyadri.edu.in/" title="Home"><img alt="sahyadri logo" src="img/download.png" width="70" height="70"></a>
        </div>
      </div>
